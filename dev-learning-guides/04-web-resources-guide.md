...
- **想定読者**: プログラミング初心者。開発を始めたが、どのサイトを参照すればいいかわからない。定番サイトを一通り把握したい
- **ゴール**: 学習・開発・デザイン・情報収集に役立つ定番サイトを知り、効率的にブックマーク整理できるようになる
- **前提**: ブラウザの基本操作ができること
- **関連ガイド**: [02 - Mac おすすめアプリガイド](02-mac-apps-guide.md)、[03 - ターミナル CLI ツールガイド](03-terminal-tools-guide.md)

> **02・03 との棲み分け**: [02](02-mac-apps-guide.md) は **Mac にインストールする GUI アプリ**、[03](03-terminal-tools-guide.md) は **ターミナルで使う CLI ツール** を紹介した。
...
- [13 - アプリケーション開発ガイド](13-claude-code-app-dev-guide.md) — API 連携の実践
- [14 - 公開・運用ガイド](14-claude-code-deploy-guide.md) — デプロイの詳細手順

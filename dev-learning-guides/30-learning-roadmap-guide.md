...
- **関連ガイド**: 本シリーズのすべてのガイド（[00](00-vscode-guide.md)〜[05](05-sns-guide.md)、および 10 番台・20 番台のガイド）

> これまでのガイド（00〜05、10〜25）は各テーマのリファレンスとして作成した。
...
| Phase 4 | [13](13-claude-code-app-dev-guide.md)・[23](23-web-basics-guide.md)・[24](24-database-intro-guide.md)・[25](25-api-guide.md) | Python・Web アプリ・DB を使ったアプリを作れる |
...
| データベース | SQLite の基本・SQL | [13](13-claude-code-app-dev-guide.md) セクション 5 | 1〜2 週間 |
| API 連携 | `requests`・API キーの管理 | [13](13-claude-code-app-dev-guide.md) セクション 6 | 1〜2 週間 |
...
| Phase 3 | [11 - Claude Code 実践](11-claude-code-practical-guide.md) |
| Phase 4 | [13 - アプリ開発](13-claude-code-app-dev-guide.md) |
| Phase 5 | [12 - 応用・自動化](12-claude-code-advanced-guide.md) |

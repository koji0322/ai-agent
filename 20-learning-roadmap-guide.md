...
- **想定読者**: プログラミング未経験〜初心者。AI を活用した開発スキルを身につけ、キャリアとして成長したい人
- **ゴール**: 学習の全体像を把握し、各段階で何を・どの順で・どのくらい学ぶかを理解できるようになる
- **前提**: 特になし（完全な初心者を想定。Mac を使用）
- **関連ガイド**: 本シリーズのすべてのガイド（[00](00-vscode-guide.md)〜[13](13-sns-guide.md)）

> これまでのガイド（00〜13）は各テーマのリファレンスとして作成した。
...
| フェーズ | 対応ガイド | 到達レベル |
|---------|-----------|-----------|
| Phase 1 | [00](00-vscode-guide.md)・[08](08-mac-finder-guide.md)・[09](09-mac-basics-guide.md) | Mac と開発ツールの基本操作ができる |
| Phase 2 | [01](01-claude-code-guide.md) | Claude Code で対話しながらファイルを作れる |
| Phase 3 | [02](02-claude-code-practical-guide.md) | Git で管理しながら開発フローで作業できる |
| Phase 4 | [04](04-claude-code-app-dev-guide.md) | Python・Web アプリ・DB を使ったアプリを作れる |
| Phase 5 | [03](03-claude-code-advanced-guide.md) | Claude Code をカスタマイズし作業を自動化できる |
| Phase 6 | [05](05-claude-code-deploy-guide.md) | アプリを公開し CI/CD で運用できる |
| Phase 7 | [06](06-claude-code-skills-guide.md)・[07](07-claude-code-multi-agent-guide.md) | スキル・マルチエージェントを使いこなせる |

> **補足**: [10](10-mac-apps-guide.md)・[11](11-terminal-tools-guide.md)・[12](12-web-resources-guide.md)・[13](13-sns-guide.md) はどのフェーズからでも参照できるリファレンスガイド。学習の進度に合わせて随時参照する。

### フェーズ別の到達レベル

| フェーズ | 期間の目安 | VBA との対比 | できるようになること |
|---------|-----------|-------------|------------------|
| Phase 1 | 0〜2 週間 | VBE を開く前段階 | Mac 操作・VS Code・ターミナルの基本ができる |
| Phase 2 | 2 週間〜1 ヶ月 | VBE を開いてコードを書く | Claude Code で指示を出しファイルを作成・編集できる |
| Phase 3 | 1〜2 ヶ月 | マクロで業務処理を作る | Git で管理しながら計画的に開発を進められる |
| Phase 4 | 2〜5 ヶ月 | アドインや独立ツールを作る | Python・Web アプリ・DB で実用的なアプリを作れる |
| Phase 5 | 5〜7 ヶ月 | 自動実行マクロ・ユーザーフォーム | カスタムコマンド・フック・MCP で環境を最適化できる |
| Phase 6 | 7〜12 ヶ月 | ツールを共有フォルダで配布・保守 | GitHub で公開し CI/CD で自動テスト・運用できる |
| Phase 7 | 12 ヶ月〜 | （VBA の枠を超える） | 複数 AI を協調させ大規模プロジェクトをリードできる |
...
| 項目 | 内容 | 対応ガイド | 学習時間の目安 |
|------|------|-----------|-------------|
| Mac の基本操作 | メニューバー・Dock・キーボード・トラックパッド | [09](09-mac-basics-guide.md) セクション 1〜5 | 2〜3 日 |
| Finder の使い方 | ファイル管理・フォルダ操作・パスの概念 | [08](08-mac-finder-guide.md) セクション 1〜5 | 1〜2 日 |
| VS Code の導入 | インストール・画面構成・基本操作 | [00](00-vscode-guide.md) セクション 1〜4 | 2〜3 日 |
| ターミナルの基礎 | 開き方・基本コマンド・パスの概念 | [01](01-claude-code-guide.md) セクション 1 | 2〜3 日 |
| Homebrew の導入 | Mac のパッケージマネージャーのインストール | [10](10-mac-apps-guide.md) セクション 2 | 1 日 |
...
> 詳細は [09 - Mac 基礎操作ガイド](09-mac-basics-guide.md) を参照。
...
Phase 1 で入れるのは最小限。学習が進んだら [10 - Mac おすすめアプリガイド](10-mac-apps-guide.md) を参照して追加する。
...
| 項目 | 内容 | 対応ガイド | 学習時間の目安 |
|------|------|-----------|-------------|
| Claude Code のインストール | npm でインストール・初回ログイン | [01](01-claude-code-guide.md) セクション 2 | 30 分 |
| 起動と終了 | プロジェクトフォルダでの起動・`Ctrl+D` で終了 | [01](01-claude-code-guide.md) セクション 3 | 30 分 |
| 基本的な対話 | 指示 → 提案 → 承認の流れ | [01](01-claude-code-guide.md) セクション 4 | 1〜2 日 |
| スラッシュコマンド | `/help`・`/clear`・`/plan` | [01](01-claude-code-guide.md) セクション 5 | 1 日 |
| パーミッションモード | デフォルト・自動承認・プランモードの使い分け | [01](01-claude-code-guide.md) セクション 7 | 1 日 |
| CLAUDE.md | プロジェクト固有の設定ファイル | [01](01-claude-code-guide.md) セクション 8 | 1 日 |
| 効果的な指示の出し方 | 具体的な指示・段階的な進め方 | [01](01-claude-code-guide.md) セクション 9 | 継続的 |
...
> VBA では「Excel を開いて VBE を起動する」手順だった。
> Claude Code では「ターミナルでプロジェクトフォルダに移動して `claude` と入力する」のが同じ手順。
...
| 項目 | 内容 | 対応ガイド | 学習時間の目安 |
|------|------|-----------|-------------|
| Git の基本概念 | バージョン管理とは何か・なぜ必要か | [02](02-claude-code-practical-guide.md) セクション 1 | 1〜2 日 |
| Git の基本コマンド | `init`・`add`・`commit`・`log`・`diff` | [02](02-claude-code-practical-guide.md) セクション 1 | 3〜4 日 |
| GitHub の使い方 | アカウント作成・SSH 設定・`push`・`pull` | [02](02-claude-code-practical-guide.md) セクション 2 | 2〜3 日 |
| 開発フロー | 調査 → 計画 → 実装 → 確認 → 記録 | [02](02-claude-code-practical-guide.md) セクション 4 | 1〜2 週間 |
| プロジェクトの始め方 | フォルダ構成・`.gitignore`・CLAUDE.md 整備 | [02](02-claude-code-practical-guide.md) セクション 3 | 1〜2 日 |
| 拡張思考モード | `Alt+T` で有効化・複雑な問題での活用 | [02](02-claude-code-practical-guide.md) セクション 5 | 1 日 |
| デバッグ | エラー貼り付け・スクリーンショット活用 | [02](02-claude-code-practical-guide.md) セクション 6 | 継続的 |
...
| 操作 | コマンド | VBA との対比 |
|------|---------|------------|
| 変更をステージする | `git add ファイル名` | 「保存する変更を選ぶ」 |
| 変更を記録する | `git commit -m "説明"` | 「名前をつけて保存」 |
| 履歴を見る | `git log --oneline` | 「変更履歴を確認」 |
| 差分を見る | `git diff` | 「前回との違いを確認」 |
| 前に戻す | `git checkout -- ファイル名` | 「元に戻す」 |
...
| 項目 | 内容 | 対応ガイド | 学習時間の目安 |
|------|------|-----------|-------------|
| Python 基礎 | 変数・リスト・辞書・関数・ファイル操作 | [04](04-claude-code-app-dev-guide.md) セクション 1 | 2〜3 週間 |
| Python 応用 | クラス・例外処理・外部ライブラリ | — | 1〜2 週間 |
| HTML / CSS / JavaScript | Web ページの構造・見た目・動き | — | 2〜3 週間 |
| コマンドラインツール | `argparse` で引数を受け取るスクリプト | [04](04-claude-code-app-dev-guide.md) セクション 3 | 1 週間 |
| Web アプリ | Streamlit（手軽）・Flask（本格的） | [04](04-claude-code-app-dev-guide.md) セクション 4 | 2〜3 週間 |
| データベース | SQLite の基本・SQL | [04](04-claude-code-app-dev-guide.md) セクション 5 | 1〜2 週間 |
| API 連携 | `requests`・API キーの管理 | [04](04-claude-code-app-dev-guide.md) セクション 6 | 1〜2 週間 |
| テスト | `pytest` の基本 | [04](04-claude-code-app-dev-guide.md) セクション 7 | 1 週間 |

### 5-1. Python の学習（Claude Code と一緒に）
...
データの永続化に SQLite を使う。Python に標準で入っているため追加インストール不要。
...
| 項目 | 内容 | 対応ガイド | 学習時間の目安 |
|------|------|-----------|-------------|
| 設定ファイル | ユーザー / プロジェクト共有 / ローカルの 3 スコープ | [03](03-claude-code-advanced-guide.md) セクション 1 | 2〜3 日 |
| CLAUDE.md 高度な活用 | 読み込み階層・禁止事項の明記 | [03](03-claude-code-advanced-guide.md) セクション 2 | 1〜2 日 |
| カスタムコマンド | `.claude/commands/` にテンプレートを配置 | [03](03-claude-code-advanced-guide.md) セクション 3 | 3〜4 日 |
| フック | `PreToolUse`・`PostToolUse`・`Notification` | [03](03-claude-code-advanced-guide.md) セクション 4 | 3〜4 日 |
| MCP | 外部ツール連携・`.mcp.json` | [03](03-claude-code-advanced-guide.md) セクション 5 | 3〜4 日 |
| ヘッドレスモード | `claude -p` でワンショット実行 | [03](03-claude-code-advanced-guide.md) セクション 6 | 1〜2 日 |
| ブランチ戦略 | 分岐・マージ・プルリクエスト | [03](03-claude-code-advanced-guide.md) セクション 7 | 3〜4 日 |
...
> VBA で言えば、`Workbook_BeforeSave` イベントでバリデーションを走らせるのに近い。
...
| 項目 | 内容 | 対応ガイド | 学習時間の目安 |
|------|------|-----------|-------------|
| README と文書整備 | プロジェクトの「顔」を整える | [05](05-claude-code-deploy-guide.md) セクション 1 | 1〜2 日 |
| 依存関係管理 | `requirements.txt`・`venv` | [05](05-claude-code-deploy-guide.md) セクション 2 | 1〜2 日 |
| GitHub 公開 | ライセンス・Issue 管理 | [05](05-claude-code-deploy-guide.md) セクション 3 | 1〜2 日 |
| 秘密情報管理 | `.env`・`.env.example`・`.gitignore` | [05](05-claude-code-deploy-guide.md) セクション 4 | 1 日 |
| デプロイ | Streamlit Cloud・GitHub Pages・Render | [05](05-claude-code-deploy-guide.md) セクション 5 | 1〜2 週間 |
| CI/CD | GitHub Actions でテスト自動実行 | [05](05-claude-code-deploy-guide.md) セクション 6 | 1〜2 週間 |
| 保守サイクル | Issue 駆動の開発・バージョニング | [05](05-claude-code-deploy-guide.md) セクション 7 | 継続的 |
| ポートフォリオ構築 | 成果物の整理・GitHub プロフィール | — | 継続的 |
| CLI ツールの活用 | モダンな開発支援ツールの導入 | [11](11-terminal-tools-guide.md) | 1〜2 週間 |
...
開発効率を上げるために、[11 - ターミナル CLI ツールガイド](11-terminal-tools-guide.md) からツールを導入する。
...
| 項目 | 内容 | 対応ガイド | 学習時間の目安 |
|------|------|-----------|-------------|
| スキル（Skills） | Claude Code の能力を拡張する知識パッケージ | [06](06-claude-code-skills-guide.md) セクション 1〜4 | 2〜3 週間 |
| プラグイン | 配布可能なスキルのパッケージ化 | [06](06-claude-code-skills-guide.md) セクション 6 | 1〜2 週間 |
| Agent Teams | 複数 AI の協調作業 | [07](07-claude-code-multi-agent-guide.md) セクション 1〜4 | 2〜3 週間 |
| Agent SDK | Python / TypeScript からの AI 制御 | [07](07-claude-code-multi-agent-guide.md) セクション 5〜6 | 2〜3 週間 |
| フルスタック開発 | フロントエンド + バックエンド + インフラ | — | 継続的 |
| チーム開発 | コードレビュー・設計・コミュニケーション | — | 実務で習得 |
| アーキテクチャ設計 | 技術選定・スケーラビリティ・保守性 | — | 継続的 |
| 最新技術のキャッチアップ | AI ツール・フレームワーク・ベストプラクティス | [12](12-web-resources-guide.md)・[13](13-sns-guide.md) | 継続的 |
...
[12 - おすすめ Web サイトガイド](12-web-resources-guide.md) と [13 - SNS・情報発信ガイド](13-sns-guide.md) を参照し、以下のルーティンを構築する。
...
| 毎日 | X で開発者のツイートを読む | [13](13-sns-guide.md) セクション 1 | 10 分 |
| 週 1 | 技術ブログを 2〜3 本読む | Zenn・dev.to | 30 分 |
| 週 1 | YouTube で技術動画を 1 本見る | [13](13-sns-guide.md) セクション 2 | 30 分 |
| 月 1 | 新しいツール / フレームワークを試す | GitHub Trending | 2〜3 時間 |
| 月 1 | Discord / Reddit のスレッドを巡回 | [13](13-sns-guide.md) セクション 3・4 | 1 時間 |
...
詳細は [12 - おすすめ Web サイトガイド](12-web-resources-guide.md) を参照。

#### Phase 1〜2（環境構築・Claude Code 入門）

| リソース | 種類 | 内容 | 言語 |
|---------|------|------|------|
| 本シリーズ [00](00-vscode-guide.md)・[01](01-claude-code-guide.md) | ガイド | VS Code・Claude Code の基礎 | 日本語 |
| 本シリーズ [08](08-mac-finder-guide.md)・[09](09-mac-basics-guide.md) | ガイド | Mac の基本操作 | 日本語 |
...
| リソース | 種類 | 内容 | 言語 |
|---------|------|------|------|
| 本シリーズ [02](02-claude-code-practical-guide.md) | ガイド | Git・GitHub・開発フロー | 日本語 |
...
| リソース | 種類 | 内容 | 言語 |
|---------|------|------|------|
| 本シリーズ [04](04-claude-code-app-dev-guide.md) | ガイド | Python・Web・DB・API 開発 | 日本語 |
...
| リソース | 種類 | 内容 | 言語 |
|---------|------|------|------|
| 本シリーズ [03](03-claude-code-advanced-guide.md)・[05](05-claude-code-deploy-guide.md) | ガイド | Claude Code 応用・デプロイ | 日本語 |
| GitHub Actions 公式ドキュメント | Web | CI/CD の設定方法 | 英語 |
| Vercel / Render 公式ドキュメント | Web | デプロイの手順 | 英語 |
| 本シリーズ [11](11-terminal-tools-guide.md) | ガイド | モダン CLI ツール | 日本語 |

#### Phase 7（プロフェッショナル）

| リソース | 種類 | 内容 | 言語 |
|---------|------|------|------|
| 本シリーズ [06](06-claude-code-skills-guide.md)・[07](07-claude-code-multi-agent-guide.md) | ガイド | スキル・マルチエージェント | 日本語 |
| React 公式チュートリアル | Web | React の基礎 | 日本語あり |
| FastAPI 公式チュートリアル | Web | Python Web API の構築 | 英語 |
| Docker 公式 Getting Started | Web | コンテナの基礎 | 英語 |
| 本シリーズ [12](12-web-resources-guide.md)・[13](13-sns-guide.md) | ガイド | Web リソース・SNS 情報収集 | 日本語 |
...
| フェーズ | 参照すべきガイド |
|---------|----------------|
| Phase 1 | [00 - VS Code](00-vscode-guide.md)、[08 - Finder](08-mac-finder-guide.md)、[09 - Mac 基礎](09-mac-basics-guide.md) |
| Phase 2 | [01 - Claude Code 基本](01-claude-code-guide.md) |
| Phase 3 | [02 - Claude Code 実践](02-claude-code-practical-guide.md) |
| Phase 4 | [04 - アプリ開発](04-claude-code-app-dev-guide.md) |
| Phase 5 | [03 - 応用・自動化](03-claude-code-advanced-guide.md) |
| Phase 6 | [05 - 公開・運用](05-claude-code-deploy-guide.md)、[11 - CLI ツール](11-terminal-tools-guide.md) |
| Phase 7 | [06 - スキル](06-claude-code-skills-guide.md)、[07 - マルチエージェント](07-claude-code-multi-agent-guide.md) |
| 全フェーズ | [10 - おすすめアプリ](10-mac-apps-guide.md)、[12 - Web サイト](12-web-resources-guide.md)、[13 - SNS](13-sns-guide.md) |
...
- [01 - Claude Code 基本操作ガイド](01-claude-code-guide.md) — ターミナルと Claude Code の基礎
- [02 - Claude Code 実践ガイド](02-claude-code-practical-guide.md) — Git・GitHub・開発フロー
- [03 - Claude Code 応用・自動化ガイド](03-claude-code-advanced-guide.md) — 設定・コマンド・フック・MCP
- [04 - Claude Code アプリケーション開発ガイド](04-claude-code-app-dev-guide.md) — Python・Web・DB・API
- [05 - Claude Code 公開・運用ガイド](05-claude-code-deploy-guide.md) — デプロイ・CI/CD・保守
- [06 - Claude Code スキル・プラグインガイド](06-claude-code-skills-guide.md) — スキル・プラグイン
- [07 - Claude Code マルチエージェントガイド](07-claude-code-multi-agent-guide.md) — 複数 AI の協調・SDK
- [08 - Mac Finder 基本操作ガイド](08-mac-finder-guide.md) — ファイル管理
- [09 - Mac 基礎操作ガイド](09-mac-basics-guide.md) — Mac の基本操作
- [10 - Mac おすすめアプリガイド](10-mac-apps-guide.md) — 開発・生産性アプリ
- [11 - ターミナル CLI ツールガイド](11-terminal-tools-guide.md) — モダン CLI ツール
- [12 - おすすめ Web サイトガイド](12-web-resources-guide.md) — 学習・AI・開発支援サイト
- [13 - 開発者向け SNS・情報発信ガイド](13-sns-guide.md) — SNS・コミュニティ
